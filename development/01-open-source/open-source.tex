...
\begin{itemize}
\item TCP/IP (1982)
% standardization of internet; easier sharing of code
\item The GNU Manifesto, Richard Stallman (1985)
% plan to write a ``free'' operating system
\item Linux kernel created, Linus Torvalds (1991)
% developed with GNU C compiler; initially solo project
\item ``The Cathedral and the Bazaar'' Eric S. Raymond (1997)
% importance of crowdsourcing the tracking of bugs
\item Experimental GNU Compiler System replaces GCC (1997-1999)
% original GCC developed as ``cathedral''
\item Netscape is open-sourced (1998), Mozilla is released (2002)
% but Netscape 4 code was scrapped and Mozilla (funded mostly by Netscape) started over
\end{itemize}
\end{frame}
