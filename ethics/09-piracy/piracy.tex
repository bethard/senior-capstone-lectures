...
United States
\begin{itemize}
\item 1992 -- Audio Home Recording Act -- levies for ``digital audio recording device'' and ``digital audio recording medium''
\end{itemize}
\end{frame}
...
Principles:
\begin{itemize}
\item Copyright: 5-20 years, non-commercial exemption, no DRM
\item Patent: no patents on life, tighten inventive/useful requirements
...
\item 2011 Sep -- German version gets 9\% of Berlin: 15 state seats
\item 2014 May -- 1 German seat (1.45\%), 0 Swedish seats (2.23\%)
\end{itemize}
\end{frame}
...
\item 2013 Jan -- Cloud-based ``Mega''; client-side encryption
\end{itemize}
\end{frame}
...
\end{itemize}
\end{itemize}
In 2013, Comcast sent out 625,000 warnings
\end{frame}
